...
$stmt = $conn->query("SELECT b.type,a.id as identifi_num,b.name,a.item_qty,b.sell_price,a.order_date,b.purchase_price FROM orders a inner
    ...
    <div>
        ...
        <div>
            ...
            <div>
                ...
                <a class="btn btn-primary" href="salesreport.php">Overall Total Daily Sales</a>
                <a class="btn btn-danger" href="salesprofitreport.php">Overall Total Daily Profit</a>
            </div>
        ...
        <div>
            <table class="table table-light table-bordered table-hover table-responsive-xl">
                ...
                <tbody>
                    ...
                    <?php 
                        ...
                        $tempcontprice = $row['purchase_price'] * $row['item_qty'];
                        $profit =  $totalprice - $tempcontprice;
                        $overalltotalprofit =$overalltotalprofit + $profit;
                    ...
                    <tr>
                        ...
                        <th scope="col"><?= $row['purchase_price']; ?></th>
            ...
            <label for="">Overall Total of Sales: <?= $overalltotalsales;?> </label><br>
            <label for="">Overall Total of Profit: <?= $overalltotalprofit;?> </label>
        </div>
